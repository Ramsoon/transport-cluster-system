<?php
	...
	if(isset($_GET['x'])){		
        ...
        ";
          ...
          echo "<script>alert('Dear User, Warning: The amount expected ($finalSum) is not the amount paid($cashGiven).')</script><font color='red'>System Detects That Our Dear Valued Customer Didn't Pay In Full. lease Take Note Of The Bill No... Balance Left: ".($finalSum - $cashGiven)."</font>";
          }
        echo "<br><br>
		<div id='leftDiv'>
